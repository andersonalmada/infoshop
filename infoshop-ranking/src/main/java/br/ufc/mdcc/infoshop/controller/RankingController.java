...
public class RankingController {
	...
	public ResponseEntity<String> getEvaluation(HttpServletRequest request, @RequestBody String feedbacks) {
		ObjectMapper objectMapper = new ObjectMapper();
		List<Feedback> listFeedbacks;

		try {
			if (request.getParameter("feedbacks") != null) {
				listFeedbacks = objectMapper.readValue(request.getParameter("feedbacks"),
			...
			return new ResponseEntity<String>(computeEvaluation(listFeedbacks), HttpStatus.OK);
	...
	public ResponseEntity<List<Ranking>> getRanking(HttpServletRequest request, @RequestBody String feedbacks) {
		ObjectMapper objectMapper = new ObjectMapper();
		List<Feedback> listFeedbacks;
		...
		try {
			...
			return new ResponseEntity<List<Ranking>>(computeRakingList(listFeedbacks), HttpStatus.OK);
		} catch (JsonProcessingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}

		return new ResponseEntity<List<Ranking>>(HttpStatus.BAD_REQUEST);
	}
